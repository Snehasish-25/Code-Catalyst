    ...
    <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-gray-300 dark:border-gray-700 py-4 gap-4">
      ...
      >
        ...
        <div className="flex flex-col gap-2">
          <h1 className="font-bold text-lg md:text-xl dark:text-gray-200">{course.title}</h1>
          ...
          <Badge className="w-fit mt-2 md:mt-0 dark:bg-blue-700 dark:text-gray-100">{course.courseLevel}</Badge>
        </div>
      </Link>
      <div className="mt-4 md:mt-0 md:text-right w-full md:w-auto">
        <h1 className="font-bold text-lg md:text-xl dark:text-gray-100">₹{course.coursePrice}</h1>
      </div>
    </div>
  );
};
